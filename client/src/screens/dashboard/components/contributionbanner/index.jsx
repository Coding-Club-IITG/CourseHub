            ...
            <div className="content">
                <div className="left">
                    ...
                    <p className="para">
                        ...
                        we'll feature your name alongside the files you contribute. You can
                        contribute by uploading a file to the appropriate folder and then requesting
                        your Branch Representative to verify the files.
                    </p>
                </div>
