...
let redirectUri = `${serverRoot}/api/auth/login/redirect`;
...
export const handleLogin = () => {
    window.location = `https://login.microsoftonline.com/850aa78d-94e1-4bc6-9cf3-8c11b530701c/oauth2/v2.0/authorize?client_id=89fc28dc-5aaf-471b-a9bf-f7411b5527f7&response_type=code&redirect_uri=${redirectUri}&scope=offline_access%20user.read&state=12345&prompt=consent`;
};
